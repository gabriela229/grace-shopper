...
const Checkout = (props) => {
    ...
    const {
        ...
        handleCardCvvInput,
        handleExpirationDateSelect,
        handleExpirationYearSelect
    } = props;
    return (
            ...
            <div className="row cart-body">
                <div className="form-horizontal">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-pull-6 col-sm-pull-6">
                        <form onSubmit={(evt) => handleCustomerInfoSubmit(checkout, lineItems, authUser, evt)}>
                            <div className="panel panel-info">
                                ...
                                <div className="panel-body">
                                    <div className="form-group">
                                        ...
                                        <div className="col-md-12">
                                            <select onChange={handleCardTypeSelect} id="CreditCardType" name="CreditCardType" className="form-control">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="col-md-12"><input onChange={handleCardNumbersInput} type="text" className="form-control" name="car_number" value={checkout.cardNumbers} /></div>
                                    </div>
                                    <div className="form-group">
                                        <div className="col-md-12"><strong>Card CVV:</strong></div>
                                        <div className="col-md-12"><input onChange={handleCardCvvInput} type="text" className="form-control" name="car_code" value={checkout.cardCvv} /></div>
                                    </div>
                                    <div className="form-group">
                                        <div className="col-md-12">
                                        ...
                                        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <select onChange={handleExpirationDateSelect} className="form-control" name="">
                                        ...
                                        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <select onChange={handleExpirationYearSelect} className="form-control" name="">
...
const mapStateToProps = ({ cart, checkout, authUser }) => {
    return {
        cart,
        checkout,
        authUser
...
const mapDispatchToProps = function (dispatch, ownProps) {
    return {
        ...
        handleCardTypeSelect: evt => {
            dispatch(cardSelect(evt.target.value));
        },
        handleCardNumbersInput: evt => {
            dispatch(writeCardNumbers(evt.target.value));
        },
        handleCardCvvInput: evt => {
            dispatch(writeCardCvv(evt.target.value));
        },
        handleExpirationDateSelect: evt => {
            dispatch(cardExpirationDateSelect(evt.target.value))
        },
        handleExpirationYearSelect: evt => {
            dispatch(cardExpirationYearSelect(evt.target.value))
        },
